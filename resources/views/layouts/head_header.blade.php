...
<html lang="en">
  <head>
    ...
    <title>TechGenie Mentor Dashboard</title>
    <!-- Google font-->
      ...
      <div class="page-main-header">
        <div class="main-header-right row m-0">
          <div class="main-header-left">
            <div class="logo-wrapper"><a href="#"><img class="img-fluid" src="../img/techgenie_logo_withname.png" alt="img"></a></div>
            <div class="dark-logo-wrapper"><a href="#"><img class="img-fluid" src="../img/techgenie_logo_withname.png" alt=""></a></div>
